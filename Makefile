...
SOURCE_LINE_SRC := src/assembler/source_line.cc $(STATUS_SRC) $(PANIC_SRC)
SIMPLEASM_SRC := src/assembler/main.cc $(SOURCE_LINE_SRC)
...
$(eval $(call unit_test,find_test,$(PANIC_SRC) $(STATUS_SRC) src/util/find_test.cc))
...
$(eval $(call unit_test,source_line_test,$(SOURCE_LINE_SRC) src/assembler/source_line_test.cc))
...
$(eval $(call binary,simpleASM,$(SIMPLEASM_SRC)))
$(eval $(call debug_binary,simpleASM-debug,$(SIMPLEASM_SRC)))
