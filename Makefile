...
$(eval $(call unit_test,memory_test,$(MEMORY_SRC),$(WIDEN_STRING_SRC) test/emulator/memory_test.cc))
$(eval $(call unit_test,decode_instruction_test,$(DECODE_INSTRUCTION_SRC),$(WIDEN_STRING_SRC) test/emulator/decode_instruction_test.cc))
$(eval $(call unit_test,emulator_test,$(EMULATOR_SRC),$(WIDEN_STRING_SRC) test/emulator/emulator_test.cc))
